    ...
    <div id={"welcome"} className="h-full grid grid-rows-2 gap-0 xl:gap-30">
      <div className="p-5 sm:p-0 flex flex-col items-center justify-center bg-green-0 gap-10">
        <div className="text-3xl lg:text-5xl text-center text-wrap">
          שחר דהן – מאמן כושר וטריאתלון מוסמך
        </div>
        <div
          dir="rtl"
        ...
        >
          ...
          אימונים פונקציונליים ופילאטיס מזרן. מאמן קבוצות רכיבת שטח למסטרס,
          ומתאים תוכניות אימון אישיות ליעדים שלכם. מתמחה בהכנת מתאמנים לתחרויות
          טריאתלון ואיש הברזל, כולל ליווי תזונתי. <br />
