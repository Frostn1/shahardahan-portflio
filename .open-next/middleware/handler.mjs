...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 165: (a, b, c) => {
      ...
      c.r(g), c.d(g, { config: () => bG, middleware: () => bF });
      let i = null;
      async function j() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = { defaultLocale: "he", locales: ["he", "en"] };
      Object.create;
      ...
      function bB(a10, b2, c2) {
        for (var d2 = 0, e2 = c2.matches; d2 < e2.length; d2++) {
          var f2 = e2[d2], g2 = bz(a10, f2.desired, c2.matchVariables) && bz(b2, f2.supported, c2.matchVariables);
          if (f2.oneway || g2 || (g2 = bz(a10, f2.supported, c2.matchVariables) && bz(b2, f2.desired, c2.matchVariables)), g2) {
            var h2 = 10 * f2.distance;
            if (c2.paradigmLocales.indexOf(bA(a10)) > -1 != c2.paradigmLocales.indexOf(bA(b2)) > -1) return h2 - 1;
            return h2;
          }
        }
      ...
      var bD = c(366), bE = c.n(bD);
      function bF(a10) {
        let b2 = a10.nextUrl.pathname;
        if (bt.locales.every((a11) => !b2.startsWith(`/${a11}/`) && b2 !== `/${a11}`)) {
          let c2 = function(a11) {
            var b3, c3;
            let d2 = {};
            a11.headers.forEach((a12, b4) => d2[b4] = a12);
            let e2 = bt.locales;
            return b3 = new (bE())({ headers: d2 }).languages(e2), c3 = bt.defaultLocale, function(a12, b4, c4, d3, e3, g2) {
              "lookup" === c4.localeMatcher ? i2 = function(a13, b5, c5) {
                for (var d4 = { locale: "" }, e4 = 0; e4 < b5.length; e4++) {
                  var f2 = b5[e4], g3 = f2.replace(bx, ""), h3 = function(a14, b6) {
                    for (var c6 = b6; ; ) {
                      if (a14.indexOf(c6) > -1) return c6;
                      var d5 = c6.lastIndexOf("-");
                      if (!~d5) return;
                      d5 >= 2 && "-" === c6[d5 - 2] && (d5 -= 2), c6 = c6.slice(0, d5);
                    }
                  }(a13, g3);
                  if (h3) return d4.locale = h3, f2 !== g3 && (d4.extension = f2.slice(g3.length, f2.length)), d4;
                }
                return d4.locale = c5(), d4;
              }(Array.from(a12), b4, g2) : (k2 = Array.from(a12), n2 = [], o2 = b4.reduce(function(a13, b5) {
                var c5 = b5.replace(bx, "");
                return n2.push(c5), a13[c5] = b5, a13;
              }, {}), (void 0 === p2 && (p2 = 838), q2 = 1 / 0, r2 = { matchedDesiredLocale: "", distances: {} }, n2.forEach(function(a13, b5) {
                r2.distances[a13] || (r2.distances[a13] = {}), k2.forEach(function(c5) {
                  var d4, e4, g3, h3, i3, j3, k3 = (d4 = new Intl.Locale(a13).maximize(), e4 = new Intl.Locale(c5).maximize(), g3 = { language: d4.language, script: d4.script || "", region: d4.region || "" }, h3 = { language: e4.language, script: e4.script || "", region: e4.region || "" }, i3 = 0, j3 = function() {
                    var a14, b6;
                    if (!f) {
                      var c6 = null == (b6 = null == (a14 = bv.supplemental.languageMatching["written-new"][0]) ? void 0 : a14.paradigmLocales) ? void 0 : b6._locales.split(" "), d5 = bv.supplemental.languageMatching["written-new"].slice(1, 5);
                      f = { matches: bv.supplemental.languageMatching["written-new"].slice(5).map(function(a15) {
                        var b7 = Object.keys(a15)[0], c7 = a15[b7];
                        return { supported: b7, desired: c7._desired, distance: +c7._distance, oneway: "true" === c7.oneway };
                      }, {}), matchVariables: d5.reduce(function(a15, b7) {
                        var c7 = Object.keys(b7)[0], d6 = b7[c7];
                        return a15[c7.slice(1)] = d6._value.split("+"), a15;
                      }, {}), paradigmLocales: bu(bu([], c6, true), c6.map(function(a15) {
                        return new Intl.Locale(a15.replace(/_/g, "-")).maximize().toString();
                      }), true) };
                    }
                    return f;
                  }(), g3.language !== h3.language && (i3 += bB({ language: d4.language, script: "", region: "" }, { language: e4.language, script: "", region: "" }, j3)), g3.script !== h3.script && (i3 += bB({ language: d4.language, script: g3.script, region: "" }, { language: e4.language, script: h3.script, region: "" }, j3)), g3.region !== h3.region && (i3 += bB(g3, h3, j3)), i3 + 0 + 40 * b5);
                  r2.distances[a13][c5] = k3, k3 < q2 && (q2 = k3, r2.matchedDesiredLocale = a13, r2.matchedSupportedLocale = c5);
                });
              ...
              j2 = i2.extension ? function(a13) {
                ...
                for (var b5, c5 = [], d4 = [], e4 = a13.length, f2 = 3; f2 < e4; ) {
                  var g3 = a13.indexOf("-", f2), h3 = void 0;
                  h3 = -1 === g3 ? e4 - f2 : g3 - f2;
                  var i3 = a13.slice(f2, f2 + h3);
                  by(h3 >= 2, "Expected a subtag to have at least 2 characters"), void 0 === b5 && 2 != h3 ? -1 === c5.indexOf(i3) && c5.push(i3) : 2 === h3 ? (b5 = { key: i3, value: "" }, void 0 === d4.find(function(a14) {
                    return a14.key === (null == b5 ? void 0 : b5.key);
                  }) && d4.push(b5)) : (null == b5 ? void 0 : b5.value) === "" ? b5.value = i3 : (by(void 0 !== b5, "Expected keyword to be defined"), b5.value += "-" + i3), f2 += h3 + 1;
                }
                return { attributes: c5, keywords: d4 };
              }(i2.extension).keywords : [];
              for (var w2 = [], x2 = function(a13) {
                var b5, d4, e4 = null != (h2 = null == u2 ? void 0 : u2[a13]) ? h2 : [];
                by(Array.isArray(e4), "keyLocaleData for ".concat(a13, " must be an array"));
                var f2 = e4[0];
                by(void 0 === f2 || "string" == typeof f2, "value must be a string or undefined");
                var g3 = void 0, i3 = j2.find(function(b6) {
                  return b6.key === a13;
                });
                if (i3) {
                  var k3 = i3.value;
                ...
                var l3 = c4[a13];
                by(null == l3 || "string" == typeof l3, "optionsValue must be a string or undefined"), "string" == typeof l3 && (b5 = a13.toLowerCase(), d4 = l3.toLowerCase(), by(void 0 !== b5, "ukey must be defined"), "" === (l3 = d4) && (l3 = "true")), l3 !== f2 && e4.indexOf(l3) > -1 && (f2 = l3, g3 = void 0), g3 && w2.push(g3), v2[a13] = f2;
              }, y2 = 0; y2 < d3.length; y2++) x2(d3[y2]);
              return w2.length > 0 && (t2 = function(a13, b5, c5) {
                by(-1 === a13.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
                for (var d4, e4 = "-u", f2 = 0; f2 < b5.length; f2++) {
                  var g3 = b5[f2];
                  e4 += "-".concat(g3);
                }
                for (var h3 = 0; h3 < c5.length; h3++) {
                  var i3 = c5[h3], j3 = i3.key, k3 = i3.value;
                  e4 += "-".concat(j3), "" !== k3 && (e4 += "-".concat(k3));
                }
                if ("-u" === e4) return bC(a13);
                var l3 = a13.indexOf("-x-");
                return bC(-1 === l3 ? a13 + e4 : a13.slice(0, l3) + e4 + a13.slice(l3));
              }(t2, [], w2)), v2.locale = t2, v2;
            }(e2, Intl.getCanonicalLocales(b3), { localeMatcher: "best fit" }, [], {}, function() {
              return c3;
            }).locale;
          }(a10);
          return T.redirect(new URL(`/${c2}${b2.startsWith("/") ? "" : "/"}${b2}`, a10.url));
        }
      }
      let bG = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bH = { ...g }, bI = bH.middleware || bH.default, bJ = "/middleware";
      ...
      function bK(a10) {
        return bg({ ...a10, page: bJ, handler: async (...a11) => {
          try {
            return await bI(...a11);
          } catch (e2) {
